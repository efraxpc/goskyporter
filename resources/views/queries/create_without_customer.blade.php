                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="us_phone_number" value="{{ old('us_phone_number') }}" required/>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="us_alternate_phone_number">US alternate phone number:</label>
                                        <input type="text" class="form-control" name="us_alternate_phone_number" value="{{ old('us_alternate_phone_number') }}" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="indian_phone" value="{{ old('indian_phone') }}" required/>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
